...
class Bassist extends Musician {
  ...
  joinBand(band) {
    this.#band = band; // метод joinBand, що змінює значення #band,this.#band = band
  }
  play() {
    console.log( `${super.name} грає на ${super.instrument} в групі ${this.#band}` )
  } // перевизначений метод play(), що виводить рядок в консоль ${super.name} грає на ${super.instrument} в групі ${this.#band}
...
Object.defineProperty(Musician.prototype, "band", {set: function(newBand) {
  this.band = newBand;
...
class Band {
  ...
  addMember(newMember) {
    ...
    if (newMember instanceof Musician) {
        ...
        console.log("Новий учасник повинен бути екземпляром класу Musician") // Якщо ні виводимо в консоль повідомлення Новий учасник повинен бути екземпляром класу Musician
      }
  }
 ...
 * | band        | "Led Zeppelin"    |
 */
let guitarist = new Guitarist("Jimmy Page", "бас-гітара", "The Beatles")
/*
 ...
 * | band        | "The Beatles"    |
 */
let bassist = new Bassist("Paul McCartney", "гітара", "Led Zeppelin")
 ...
 */
let performance = new Performance(band, "Liverpool", new Date())
 ...
 * | ticketPrice | 100              |
 */
  let concert = new Concert(band, "BBC studios", new Date(), 100)
/*
